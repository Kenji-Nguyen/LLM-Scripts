...
## Add a New Project
1. Copy `knowledge/templates/PROJECT_KNOWLEDGE.template.md` into `knowledge/projects/<project_id>/PROJECT_KNOWLEDGE.md`.
2. Add one row to this registry.
3. Add the new page link to `docs/INDEX.md`.
